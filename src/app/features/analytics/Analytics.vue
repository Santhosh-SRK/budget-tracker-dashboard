        ...
        <div class="space-y-4">
          <div>
            <div class="flex justify-between mb-1">
              ...
              <span class="text-sm font-medium">$345.50</span>
            </div>
          ...
          <div>
            <div class="flex justify-between mb-1">
              ...
              <span class="text-sm font-medium">$200.00</span>
            </div>
            <div class="w-full bg-gray-200 rounded-full h-2">
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-3">
          <div class="flex justify-between">
            ...
            <span class="font-semibold text-green-600">+$3,500.00</span>
          </div>
          <div class="flex justify-between">
            <span class="text-gray-600">Expenses</span>
            <span class="font-semibold text-red-600">-$735.00</span>
          </div>
          <div class="border-t pt-3 flex justify-between">
            <span class="font-semibold">Net</span>
            <span class="font-semibold text-green-600">+$2,765.00</span>
          </div>
        </div>
      </div>
    </div>
